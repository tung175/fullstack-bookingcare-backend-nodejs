...
module.exports = {
  getTopDoctorHome, getAllDoctors, postInforDoctor, getDetailDoctorById, postBulkCreateSchedule, getScheduleByDate, getExtraInforDoctorById, getProfileDoctorById
};
